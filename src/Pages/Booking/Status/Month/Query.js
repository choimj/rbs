...
`;
//duplicatedCheckCreateBooking
export const DUPLICATED_CHECK_CREATE_BOOKING = gql`
  mutation duplicatedCheckCreateBooking(
    $filter: BookingFilterInput
    $data: BookingCreateInput!
  ) {
    duplicatedCheckCreateBooking(filter: $filter, data: $date) {
      id
      title
      date
      startTime
