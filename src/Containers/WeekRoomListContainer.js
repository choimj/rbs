...
class WeekRoomListContainer extends React.Component {
   ...
   */
  bookingListGlobal = {"r1" : [
    // {bookDate: "2019-08-19", bookTitle: "Title1", bookDept: "UI/UX Core", bookName: "홍길동", startHour: 9, startMinute: 0, endHour: 10, endMinute: 0},
    {bookDate: "2019-08-20",bookTitle: "Title2", bookDept: "Cell6", bookName: "최민지", startHour: 13, startMinute: 0, endHour: 15, endMinute: 0},
    {bookDate: "2019-08-20",bookTitle: "Title3", bookDept: "경영관리", bookName: "홍길동", startHour: 16, startMinute: 0, endHour: 16, endMinute: 30}    
  ]};
  thisWeek = [];
  bookingList = [];
          ...
          <ul>
            <li> 
              ...
              <WeekSpan istoday={tItem.isToday}>
                <TimeBlock openTime={openTime} closeTime={closeTime} day={tItem.day} bookingList={thisWeekBookingList}/>
              </WeekSpan>
            </li>
          </ul>
        </Root>
